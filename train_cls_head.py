...
if __name__ == '__main__':
    ...
    parser.add_argument("-tbs", "--train_batch_size", type = int, required=True)
    ...
    parser.add_argument("-msd", "--model_save_dir",  default = '/mnt/swordfish-pool2/kh3074/neg_pos_rate2/trained_cls_head_model')
    ...
    my_nvlr_model.load_pretrained('data/cclm_4m_epoch_29.th', config,  ## need to match 3m or 4m
                                  load_nlvr_pretrain= False, is_eval=False) # load_nlvr_pretrain= False because current checkpoint is CCLM model and do not have cls head
    ...
    for epoch in range(num_epoch):
        ...
        train_result_df.to_csv(os.path.join(log_save_dir,'train_epoch_for_cls_head'))
